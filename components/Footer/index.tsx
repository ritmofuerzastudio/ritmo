...
const Footer = () => {
  return (
    <footer className="bg-[#F5CF82] text-[#AE6B56] pt-4 md:pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-[#AE6B56] pt-2 md:pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#AE6B56] text-sm mb-4 md:mb-0 text-center md:text-left">
